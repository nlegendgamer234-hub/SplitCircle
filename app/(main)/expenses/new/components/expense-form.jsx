      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="amount" placeholder="0.00" type="number" step="0.01" min="0.01" {...register("amount")} />
        ...
        {type === "group" && (
          <div className="space-y-2">
            ...
            />
            {!selectedGroup && <p className="text-xs text-amber-600">Please select a group to continue</p>}
          </div>
        )}
        ...
        {type === "individual" && (
          <div className="space-y-2">
            ...
            {participants.length <= 1 && <p className="text-xs text-amber-600">Please add at least one other participant</p>}
          </div>
        )}
