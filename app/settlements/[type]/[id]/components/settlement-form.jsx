        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            {groupMembers.map((member) => {
              ...
              return (
                <div key={member.userId} className={`border rounded-md p-3 cursor-pointer transition-colors ${isSelected ? "border-primary bg-primary/5" : "hover:bg-muted/50"}`} onClick={() => setSelectedGroupMemberId(member.userId)}>
                ...
                <div className="flex items-center space-x-2 border rounded-md p-3">
                  ...
                  <Label htmlFor="youPaid" className="flex-grow cursor-pointer">
                    <div className="flex items-center">
                      ...
                      <span>You paid {groupMembers.find((m) => m.userId === selectedGroupMemberId)?.name}</span>
                    </div>
                  </Label>
                </div>
