...
export function ExpenseList({ expenses, showOtherPerson = true, isGroupExpense = false, otherPersonId = null, userLookupMap = {} }) {
                ...
                <div className="flex items-center gap-2">
                  <div className="text-right">
                    ...
                    {isGroupExpense ? (
                      ...
                      <div className="text-sm text-muted-foreground">{isCurrentUserPayer ? <span className="text-green-600">You paid</span> : <span className="text-red-600">{payer.name} paid</span>}</div>
                    )}
                  </div>

                  {showDeleteOption && (
                    <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full text-red-500 hover:text-red-700 hover:bg-red-100" onClick={() => handleDeleteExpense(expense)}>
