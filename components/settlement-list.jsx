            ...
            <CardContent className="py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-medium">{isCurrentUserPayer ? `You paid ${receiver.name}` : isCurrentUserReceiver ? `${payer.name} paid you` : `${payer.name} paid ${receiver.name}`}</h3>
                ...
                <div className="text-right">
                  ...
                  {isGroupSettlement ? (
                    ...
                    <div className="text-sm text-muted-foreground">{isCurrentUserPayer ? <span className="text-amber-600">You paid</span> : isCurrentUserReceiver ? <span className="text-green-600">You received</span> : <span>Payment</span>}</div>
                  )}
                </div>
              </div>
            </CardContent>
